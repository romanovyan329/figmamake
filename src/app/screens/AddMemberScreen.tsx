import { ArrowLeft, User, MapPin, Trophy, FileText } from 'lucide-react';
...
export function AddMemberScreen({ onNavigate, onBack }: AddMemberScreenProps) {
  const { selectedTeamId, createTeamMember, teams } = useApp();
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!formData.fullName || !formData.country || !selectedTeamId) {
      alert('Please fill in all required fields');
      return;
    }

    createTeamMember(selectedTeamId, {
